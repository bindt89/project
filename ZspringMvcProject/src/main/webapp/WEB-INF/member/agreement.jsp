...
<div id="header" role="banner"  >
    <h1><a href="index.jsp" class="h_logo" ><span  class="blind">Will</span></a></h1>
    <div class="lang"  >
                ...
                <form id="join" method="GET" action="/user2/V2Join.nhn?m=begin" >
                    ...
                    <div class="terms_p">
                        ...
                        <span class="input_chk">
                           ...
                           <label for="chk_all"><span class="chk_all_txt">Will 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택),<br class='m_br'> 프로모션 정보 수신(선택)에 모두 동의합니다.</span></label>
                              </span>
                        </p>
                        <ul class="terms_bx_list">
                            <li class="terms_bx">
                           <span class="input_chk"> 
                              <input type="checkbox" id="termsService" name="termsService" class="chk"> &emsp;
                              <label for="termsService">Will 이용약관 동의<span class="terms_necessary">(필수)</span></label>
                           </span>
    ...
    <p class="article__text">
        Will 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다.
        본 약관은 다양한  Will 서비스의 이용과 관련하여 Will서비스를 제공하는 Will 회사(이하 ‘Will’)와
        이를 이용하는 Will 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며,
        아울러 여러분의 Will 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
    </p>
    <p class="article__text">
        Will 서비스를 이용하시거나 Will 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로,
...
<div class="article">
    ...
    <p class="article__text">
        Will는 <a href="index.jsp" target="_blank">index.jsp</a>을 비롯한 Will 도메인의 웹사이트 및 응용프로그램을 통해 정보 검색,
        다른 이용자와의 커뮤니케이션, 콘텐츠 제공, 상품 쇼핑 등 여러분의 생활에 편리함을 더할 수 있는 다양한 서비스를 제공하고 있습니다.<br>
        여러분은 PC등 인터넷 이용이 가능한  단말기를 통해 각양각색의 Will 서비스를 자유롭게 이용하실 수 있으며,
        개별 서비스들의 구체적인 내용은 각 서비스 상의 안내, 공지사항 Will Q&A 등에서 쉽게 확인하실 수 있습니다.
    </p>
    <p class="article__text">
        Will는 기본적으로 여러분 모두에게 동일한 내용의 서비스를 제공합니다.
...
<div class="article">
    ...
    <p class="article__text">
        ...
        Will는 이에 대한 승낙을 통해 회원 가입 절차를 완료하고 여러분께 Will 서비스 이용 계정(이하 ‘계정’)을 부여합니다.
        계정이란 회원이 Will 서비스에 로그인한 이후 이용하는 각종 서비스 이용 이력을 회원 별로 관리하기 위해 설정한 회원 식별 단위를 말합니다.
        회원은 자신의 계정을 통해 좀더 다양한 Will 서비스를 보다 편리하게 이용할 수 있습니다.
    </p>
    <p class="article__text">
        Will는 단체에 속한 여러 구성원들이 공동의 계정으로 Will 서비스를 함께 이용할 수 있도록 단체회원 계정도 부여하고 있습니다.
        ...
        멤버들의 단체회원 계정 로그인 방법 및 이를 통한 게시물 게재 등 Will 서비스 이용을 관리(게시물 삭제 포함)할 수 있습니다.
...
<div class="article">
    ...
    <p class="article__text">
        Will는 여러분이 게재한 게시물이 Will 서비스를 통해 다른 이용자들에게 전달되어 우리 모두의 삶을 더욱 풍요롭게 해줄 것을 기대합니다.
        게시물은 여러분이 타인 또는 자신이 보게 할 목적으로 Will 서비스 상에 게재한 부호, 문자,  등으로
        구성된 각종 콘텐츠 자체 또는 파일을 말합니다.
    </p>
    <p class="article__text">
        Will는 여러분의 생각과 감정이 표현된 콘텐츠를 소중히 보호할 것을 약속 드립니다.
        여러분이 제작하여 게재한 게시물에 대한 지식재산권 등의 권리는 당연히 여러분에게 있습니다.
    </p>
    <p class="article__text">
        한편, Will 서비스를 통해 여러분이 게재한 게시물을 적법하게 제공하려면 해당 콘텐츠에 대한 저장, 복제, 수정, 공중 송신, 전시, 배포,
    ...
    <p class="article__text">
        Will는 여러분이 부여해 주신 콘텐츠 이용 권한을 저작권법 등 관련 법령에서 정하는 바에 따라 Will 서비스 내 노출, 서비스 홍보를 위한 활용,
    ...
    <p class="article__text">
        Will는 여러분이 자신이 제공한 콘텐츠에 대한 Will 또는 다른 이용자들의 이용 또는 접근을 보다 쉽게 관리할 수 있도록 다양한 수단을 제공하기 위해 노력하고 있습니다.
        여러분은 Will 서비스 내에 콘텐츠 삭제, 비공개 등의 관리기능이 제공되는 경우 이를 통해 직접 타인의 이용 또는 접근을 통제할 수 있고,
        고객센터를 통해서도 콘텐츠의 삭제, 비공개, 검색결과 제외 등의 조치를 요청할 수 있습니다.<br>
        다만, 일부 Will 서비스의 경우 삭제, 비공개 등의 처리가 어려울 수 있으며,
...
<div class="article">
    ...
    <p class="article__text">
        Will는 서비스의 원활한 제공을 위하여 회원이 동의한 목적과 범위 내에서만 개인정보를 수집∙이용하며, 개인정보 보호 관련 법령에 따라 안전하게 관리합니다.
        Will가 이용자 및 회원에 대해 관련 개인정보를 안전하게 처리하기 위하여 기울이는 노력이나
    </p>
    <p class="article__text">
        Will 여러분이 서비스를 이용하기 위해 일정 기간 동안 로그인 혹은 접속한 기록이 없는 경우, 전자메일, 서비스 내 알림 또는 기타 적절한 전자적 수단을 통해 사전에 안내해 드린 후 여러분의 정보를 파기하거나 분리 보관할 수 있으며,
...
<div class="article">
    ...
    <p class="article__text">
        ...
        Will는 이에 대한 문제 해결을 위해 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’ 및 ‘저작권법’ 등을
        근거로 권리침해 주장자의 요청에 따른 게시물 게시중단, 원 게시자의 이의신청에 따른 해당 게시물 게시 재개 등을 내용으로 하는
        게시중단요청 할 수 있습니다.
   </p>
    <p class="article__text">
        한편, Will 서비스를 통해 타인의 콘텐츠를 이용한다고 하여 여러분이 해당 콘텐츠에 대한 지식재산권을 보유하게 되는 것은 아닙니다.
        여러분이 해당 콘텐츠를 저작권법 등 관련 법률에 따라 허용되는 범위 내에 있거나,
        해당 콘텐츠의 지식재산권자로부터 별도의 이용 허락을 받아야 하므로 각별한 주의가 필요합니다.
    </p>
    <p class="article__text">
        Will는 여러분이 Will 서비스를 마음껏 이용할 수 있도록 여러분께 Will 서비스에 수반되는 관련 소프트웨어 사용에 관한 이용 권한을 부여합니다.
        이 경우 여러분의 자유로운 이용은 Will가 제시하는 이용 조건에 부합하는 범위 내에서만 허용되고, 이러한 권한은 양도가 불가능하며,
        비독점적 조건 및 법적고지가 적용된다는 점을 유의해 주세요.
    </p>
</div>
<div class="article">Will 서비스 이용과 관련하여 몇 가지 주의사항이 있습니다.</h3>
    <p class="article__text">
       Will는 여러분이 Will 서비스를 자유롭고 편리하게 이용할 수 있도록 최선을 다하고 있습니다.
        다만, 여러분이 Will 서비스를 보다 안전하게 이용하고 Will 서비스에서 여러분과 타인의 권리가 서로 존중되고 보호받으려면
        여러분의 도움과 협조가 필요합니다. 여러분의 안전한 서비스 이용과 권리 보호를 위해 부득이 아래와 같은 경우
        여러분의 게시물 게재나 Will 서비스 이용이 제한될 수 있으므로, 이에 대한 확인 및 준수를 요청 드립니다.
    </p>
    <ul class="article__text">
        ...
        <li class="article__text__list">
            자동화된 수단을 활용하는 등 Will 서비스의 기능을 비정상적으로 이용하여 게재된 게시물, Will 각 개별 서비스의 제공 취지와
            부합하지 않는 내용의 게시물은 다른 이용자들의 정상적인 Will 서비스 이용에 불편을 초래하고 더 나아가 Will의 원활한 서비스 제공을 방해하므로 역시 제한될 수 있습니다.
            기타 제한되는 게시물에 관한 상세한 내용은 <em>게시물 운영정책</em> 및 각 개별 서비스에서의 약관, 운영정책 등을 참고해 주시기 바랍니다.
        </li>
        <li class="article__text__list">
                                       <span class="article__text">Will의 사전 허락 없이 자동화된 수단(예: 매크로 프로그램, 로봇(봇), 스파이더, 스크래퍼 등)을 이용하여 Will 서비스 회원으로 가입을 시도 또는 가입하거나,
                                       Will 서비스에 로그인을 시도 또는 로그인하거나, Will 서비스 상에 게시물을 게재하거나, Will서비스를 통해 커뮤니케이션하거나(예: 전자메일, 쪽지 등),</span>
            Will 서비스에 게재된 회원의 아이디(ID), 게시물 등을 수집하거나, Will 검색 서비스에서 특정 질의어로 검색하거나
            혹은 그 검색결과에서 특정 검색결과를 선택(이른바 ‘클릭’)하는 등 <span class="article__text">이용자(사람)의 실제 이용을 전제로 하는 Will 서비스의 제공 취지에 부합하지 않는 방식으로
                                       Will 서비스를 이용하거나 이와 같은 Will 서비스에 대한 어뷰징(남용) 행위를 막기 위한 Will의 기술적 조치를 무력화하려는 일체의 행위</span>(예: IP를 지속적으로 바꿔가며 접속하는 행위,
            Captcha를 외부 솔루션 등을 통해 우회하거나 무력화 하는 행위 등)를 시도해서는 안 됩니다.
        </li>
        <li class="article__text__list">
                                       <span class="article__text">Will의 동의 없이 자동화된 수단에 의해 Will 서비스 상에 광고가 게재되는 영역 또는 그 밖의 영역에 부호, 문자, 음성, 음향, 그림, 사진, 동영상, 링크 등으로
                                       구성된 각종 콘텐츠 자체 또는 파일을 삽입</span>해서는 안 됩니다. 또한, Will 서비스 또는 이에 포함된 소프트웨어를 복사, 수정할 수 없으며,
            이를 판매, 양도, 대여 또는 담보로 제공하거나 타인에게 그 이용을 허락해서는 안 됩니다. Will 서비스에 포함된 소프트웨어를 역 설계, 소스코드 추출 시도,
            복제, 분해, 모방, 기타 변형하는 등의 행위도 금지됩니다(다만, 오픈소스에 해당되는 경우 그 자체 조건에 따릅니다).
            <span class="article__text">그 밖에 바이러스나 기타 악성 코드를 업로드하거나 Will 서비스의 원활한 운영을 방해할 목적으로 서비스 기능을 비정상적으로 이용하는 행위</span> 역시 금지됩니다.
        </li>
    </ul>
    
    <p class="article__text">
        Will는 본 약관의 범위 내에서 게시물 운영정책, 각 개별 서비스에서의 약관 또는 운영정책, 각 서비스 상의 안내, 공지사항, Q&A 도움말 등을 두어,
...
<div class="article">
    ...
    <p class="article__text">
        Will는 다양한 정보와 의견이 담긴 여러분의 콘텐츠를 소중히 다룰 것을 약속 드립니다만, 여러분이 게재한 게시물이 관련 법령, 본 약관, 게시물 운영정책,
        각 개별 서비스에서의 약관, 운영정책 등에 위배되는 경우, 부득이 이를 비공개 또는 삭제 처리하거나 게재를 거부할 수 있습니다.
        다만, 이것이 Will가 모든 콘텐츠를 검토할 의무가 있다는 것을 의미하지는 않습니다.
    </p>
    <p class="article__text">
        또한 여러분이 관련 법령, 본 약관, 계정 및 게시물 운영정책, 각 개별 서비스에서의 약관, 운영정책 등을 준수하지 않을 경우,
         Will는 여러분의 관련 행위 내용을 확인할 수 있으며, 그 확인 결과에 따라 Will 서비스 이용에 대한 주의를 당부하거나,
       Will 서비스 이용을 일부 또는 전부, 일시 또는 영구히 정지시키는 등 그 이용을 제한할 수 있습니다.
        한편, 이러한 이용 제한에도 불구하고 더 이상 Will 서비스 이용계약의 온전한 유지를 기대하기 어려운 경우엔 부득이 여러분과의 이용계약을 해지할 수 있습니다.
    </p>
    <p class="article__text">
...
<div class="article">
    ...
    <p class="article__text">
       Will는 여러분이 Will 서비스를 이용함에 있어 Will의 고의 또는 과실로 인하여 손해를 입게 될 경우 관련 법령에 따라 여러분의 손해를 배상합니다.
        다만, 천재지변 또는 이에 준하는 불가항력으로 인하여 Will가 서비스를 제공할 수 없거나 이용자의 고의 또는 과실로 인하여 서비스를 이용할 수 없어
        발생한 손해에 대해서 Will는 책임을 부담하지 않습니다.
    </p>
    <p class="article__text">
        그리고 Will가 손해배상책임을 부담하는 경우에도 통상적으로 예견이 불가능하거나 특별한 사정으로 인한 특별 손해 또는 간접 손해,
        기타 징벌적 손해에 대해서는 관련 법령에 특별한 규정이 없는 한 책임을 부담하지 않습니다.
    </p>
    <p class="article__text">
        한편, Will 서비스를 매개로 한 여러분과 다른 회원 간 또는 여러분과 비회원 간의 의견 교환,
        거래 등에서 발생한 손해나 여러분이 서비스 상에 게재된 타인의 게시물 등의 콘텐츠를 신뢰함으로써 발생한 손해에 대해서도
        Will는 특별한 사정이 없는 한 이에 대해 책임을 부담하지 않습니다.
    </p>
</div>
<div class="article">
    <h3 class="article__title">언제든지 Will 서비스 이용계약을 해지하실 수 있습니다.</h3>
    <p class="article__text">
        Will에게는 참 안타까운 일입니다만, 회원은 언제든지 Will 서비스 이용계약 해지를 신청하여 회원에서 탈퇴할 수 있으며,
        이 경우  Will는 관련 법령 등이 정하는 바에 따라 이를 지체 없이 처리하겠습니다.
    </p>
    <p class="article__text">
        Will 서비스 이용계약이 해지되면, 관련 법령 및 개인정보처리방침에 따라 Will가 해당 회원의 정보를 보유할 수 있는 경우를 제외하고,
...
<div class="article">
    ...
    <p class="article__text">
        Will는 연중 무휴, 1일 24시간 안정적으로 서비스를 제공하기 위해 최선을 다하고 있습니다만, 컴퓨터, 서버 등 정보통신설비의 보수점검,
        교체 또는 고장, 통신두절 등 운영상 상당한 이유가 있는 경우 부득이 서비스의 전부 또는 일부를 중단할 수 있습니다.
    </p>
    <p class="article__text">
        한편, Will는 서비스 운영 또는 개선을 위해 상당한 필요성이 있는 경우 서비스의 전부 또는 일부를 수정, 변경 또는 종료할 수 있습니다.
        무료로 제공되는 서비스의 전부 또는 일부를 수정, 변경 또는 종료하게 된 경우 관련 법령에 특별한 규정이 없는 한 별도의 보상을 하지 않습니다.
    </p>
    <p class="article__text">
        이 경우 Will는 예측 가능한 경우 상당기간 전에 이를 안내하며, 만약 예측 불가능한 경우라면 사후 지체 없이 상세히 설명하고 안내 드리겠습니다.
...
<div class="article">
    ...
    <p class="article__text">
        Will는 서비스 이용에 필요한 주요사항을 적시에 잘 안내해 드릴 수 있도록 힘쓰겠습니다.
        회원에게 통지를 하는 경우 전자메일, 서비스 내 알림 또는 기타 적절한 전자적 수단을 통해 개별적으로 알려 드릴 것이며,
        다만 회원 전체에 대한 통지가 필요할 경우엔 7일 이상 <a href="index.hsp" target="_blank">index.jsp</a>을 비롯한  Will 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)
        초기 화면 또는 공지사항 등에 관련 내용을 게시하도록 하겠습니다.
    </p>
    <p class="article__text">
        Will는 여러분의 소중한 의견에 귀 기울이겠습니다. 여러분은 언제든지 고객센터를 통해 서비스 이용과 관련된 의견이나 개선사항을 전달할 수 있으며,
        Will는 합리적 범위 내에서 가능한 그 처리과정 및 결과를 여러분께 전달할 수 있도록 하겠습니다.
    </p>
</div>                                </div>
...
<div class="policy_summary">
    <p class="policy_summary__text">개인정보보호법에 따라 Will에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p>
</div>
<div class="article">
    <h3 class="article__title">1. 수집하는 개인정보</h3>
    <p class="article__text">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 Will 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 내용작성,공증,Q&A 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우,  Will는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
    <div class="clause">
        ...
        <p class="clause__text">Will 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.</p>
...
<div class="article">
    ...
    <p class="article__text"> Will 및 Will 관련 제반 서비스의 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.</p>
    <ul class="sections">
...
<div class="article">
    ...
    <div class="clause">
        ...
        <ul class="sections">
            <li class="sections__section">- 부정 가입 및 이용 방지
                <br>가입인증 휴대전화번호 또는DI (만14세 미만의 경우 법정대리인DI) : 수집시점으로부터6개월 보관
                <br>탈퇴한 이용자의 휴대전화번호(복호화가 불가능한 일방향 암호화(해시처리)) : 탈퇴일로부터6개월 보관
            </li>
    ...
    <div class="clause">
        <h4 class="clause__title">
            ...
            Will는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.
        </h4>
        <ul class="sections">
                           ...
                           <span class="input_chk">
                              ...
                              <label for="termsLocation">위치정보 이용약관 동의<span class="terms_choice terms_no">(선택)</span></label>
                                ...
                                <div class="terms_box" id="divLocation">
                                    <!-- 위치정보 이용약관 동의 -->
<div class="policy_summary">
                        <p class="policy_summary__text">위치정보 이용약관에 동의하시면, <strong>위치를 활용한 광고 정보 수신</strong> 등을 포함하는 Will 위치기반 서비스를 이용할 수 있습니다.</p><br>
                     </div>
                     <div class="article">
                        <h3 class="article__title">제 1 조 (목적)</h3>
                        <p class="article__text">이 약관은 Will 회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
                     </div>
                     <div class="article">
                    ...
                    <div class="btn_area double">
                          <span><!-- tg-text=terms_button_agree --><a href="#"  onclick="location.href='index.jsp?join'" id="btnAgree" type="button"  class="btn-primary" role="button">확인</a></span>
                        <span><!-- tg-text=terms_button_cancel --><a href="#"   onclick="location.href='index.jsp?home'"id="btnCancel"type="button"  class="btn-btn-primary" role="button">취소</a></span>
